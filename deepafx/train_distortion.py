...
from deepafx import config_distortion
from deepafx import evaluate

tf.random.set_seed(0)
np.random.seed(0)

k = config_distortion.k
...
if not os.path.isdir(kPathModels):
    ...
    print("Folder created: ", kPathModels)
...
# Pretrains to default parameter values
if kDefaultPretraining:
    ...
    genTrain = generators.Data_Generator_Stateful_Distortion(xTrainAudio, yTrainAudio, dafx,
                                               kBatchSize,
                                               kNumSamples,
                                               ...
                                               crop=True,
                                               output_length=kOutputLength,
                                               center_frames=True, default=True)
    
    genValid = generators.Data_Generator_Stateful_Distortion(xValidAudio, yValidAudio, dafx,
                                               kBatchSize,
                                               kNumSamples,
                                               steps_per_epoch=kStepsPerEpoch,
                                               sr=kSR,
...
genTrain = generators.Data_Generator_Stateful_Distortion(xTrainAudio, yTrainAudio, dafx,
                                               ...
                                               crop=True,
                                               output_length=kOutputLength,
                                               center_frames=True, default=False)
...
# evaluate.evaluate(kModelID, kPathModels, 'distortion')
print('model_weights_path', model_weights_path)
print('params_path', params_path)
print('results_dir', results_dir)
evaluate.evaluate(model_weights_path, params_path, 'distortion', results_dir)